      ...
      <div className="projects">
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              ...
              <p>
                {" "}
                I have developed a dynamic and responsive portfolio using
                React.js, showcasing my skills and projects in web development.
                The portfolio is designed with a clean and modern UI, featuring
                smooth navigation and interactive elements. I utilized React
                components to ensure reusability and maintainability across the
                project.{" "}
              </p>
            </div>
            <footer>
              ...
              <ul className="tech-list">
                {" "}
                <li>Interactive</li> <li>API Gateway</li> <li>DynamoDB</li>{" "}
              </ul>{" "}
            </footer>
          </div>
        </ScrollAnimation>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              <h3>Movie Rating Application</h3>
              <p>
                I developed a feature-rich movie rating application using
                React.js, allowing users to rate movies, add them to their
                watchlist, and explore detailed information about each movie.
                The app features a sleek and intuitive UI, built with reusable
                React components, ensuring efficient performance and easy
                maintenance. Users can submit ratings in both number and star
                formats, and the app dynamically updates movie rankings based on
                user feedback.
              </p>
            </div>
            <footer>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              ...
              <p>
                I developed an electricity billing system using Java and Swing
                to provide an efficient solution for managing customer billing
                information. The system features an intuitive graphical user
                interface (GUI) built with Swing, allowing users to input,
                update, and view billing details seamlessly. Java's JDBC was
                utilized to connect with a MySQL database for securely storing
                customer data, billing history, and payment information.
              </p>
            </div>
            <footer>
              <ul className="tech-list">
